...
function getEndpoints(deviceAddress, endpoints) {
    ...
    var e = endpoints.addEndpoint("2", "Flow Rate", endpointType.genericSensor);
    e.variableTypeId = 1181;
    endpoints.addEndpoint("3", "Cumulative flow", endpointType.flowSensor);
    endpoints.addEndpoint("4", "Reverse cumulative flow", endpointType.flowSensor);
    endpoints.addEndpoint("5", "Daily cumulative flow", endpointType.flowSensor);
}
