...
# Parsing + Configuration Script – Aclus - V - Rev. A

This **Parsing + Configuration** script is designed for the **Aclus - V** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Aclus - V Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Aclus - V** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
